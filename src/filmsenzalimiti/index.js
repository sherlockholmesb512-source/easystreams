...
const SITE_BASE = 'https://filmsenzalimiti.study';
const SEARCH_PROXY_BASE = 'https://altadefinizionex.one';
const SITE_LABEL = 'FilmSenzaLimiti';

async function searchCandidates(title) {
  const html = await fetchText(`${SEARCH_PROXY_BASE}/search?q=${encodeURIComponent(title)}`, {
